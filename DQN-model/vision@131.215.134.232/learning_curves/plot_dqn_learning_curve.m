cd('/home/vision/Desktop/relDQN/DQN-OO-V12/learning_curves/trial_john/')
...
frames_vanilla = s2{1}(floor(window_size_v/2):end-(window_size_v - floor(window_size_v/2))); 
episodes_object = s1{2}(floor(window_size/2):end-(window_size - floor(window_size/2)));
episodes_vanilla = s2{2}(floor(window_size_v/2):end-(window_size_v - floor(window_size_v/2))); 
