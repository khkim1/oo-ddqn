...
inline float ArraysExtraInfo_Entry::min() const {
  // @@protoc_insertion_point(field_get:toco.ArraysExtraInfo.Entry.min)
  return min_;
}
inline void ArraysExtraInfo_Entry::set_min(float value) {
  set_has_min();
  min_ = value;
...
inline float ArraysExtraInfo_Entry::max() const {
  // @@protoc_insertion_point(field_get:toco.ArraysExtraInfo.Entry.max)
  return max_;
}
inline void ArraysExtraInfo_Entry::set_max(float value) {
  set_has_max();
  max_ = value;
