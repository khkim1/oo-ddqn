...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "ependency\030\014 \001(\010*\\\n\nFileFormat\022\027\n\023FILE_FO"
      "RMAT_UNKNOWN\020\000\022\027\n\023TENSORFLOW_GRAPHDEF\020\001\022"
...
TocoFlags::TocoFlags(const TocoFlags& from)
  ...
  ::memcpy(&input_format_, &from.input_format_,
    static_cast<size_t>(reinterpret_cast<char*>(&inference_input_type_) -
    reinterpret_cast<char*>(&input_format_)) + sizeof(inference_input_type_));
...
void TocoFlags::SharedCtor() {
  ...
  ::memset(&input_format_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&inference_input_type_) -
      reinterpret_cast<char*>(&input_format_)) + sizeof(inference_input_type_));
}
...
// @@protoc_insertion_point(message_clear_start:toco.TocoFlags)
  ...
  if (cached_has_bits & 768u) {
    ::memset(&drop_control_dependency_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&inference_input_type_) -
        reinterpret_cast<char*>(&drop_control_dependency_)) + sizeof(inference_input_type_));
  }
  _has_bits_.Clear();
