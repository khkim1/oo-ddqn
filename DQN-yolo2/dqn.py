...
class StateDQN(DQN):
    ...
    def _create_outputs(self, x):
        ...
        x = tf.layers.dense(x, units=4096, activation=tf.nn.relu, name='fc1',
                            kernel_initializer=tf.contrib.layers.xavier_initializer(),
                            bias_initializer=tf.contrib.layers.xavier_initializer())
        x = tf.layers.dense(x, units=2048, activation=tf.nn.relu, name='fc2',
                            kernel_initializer=tf.contrib.layers.xavier_initializer(),
                            bias_initializer=tf.contrib.layers.xavier_initializer())
        x = tf.layers.dense(x, units=1024, activation=tf.nn.relu, name='fc3',
                            kernel_initializer=tf.contrib.layers.xavier_initializer(),
                            bias_initializer=tf.contrib.layers.xavier_initializer())
        x = tf.layers.dense(x, units=1024, activation=tf.nn.relu, name='fc4',
                            kernel_initializer=tf.contrib.layers.xavier_initializer(),
                            bias_initializer=tf.contrib.layers.xavier_initializer())
        ...
        x = tf.layers.dense(x, units=512, activation=tf.nn.relu, name='fc6',
                            kernel_initializer=tf.contrib.layers.xavier_initializer(),
                            bias_initializer=tf.contrib.layers.xavier_initializer())
        x = tf.layers.dense(x, units=256, activation=tf.nn.relu, name='fc7',
                            kernel_initializer=tf.contrib.layers.xavier_initializer(),
                            bias_initializer=tf.contrib.layers.xavier_initializer())
        x = tf.layers.dense(x, units=256, activation=tf.nn.relu, name='fc8',
                            kernel_initializer=tf.contrib.layers.xavier_initializer(),
                            bias_initializer=tf.contrib.layers.xavier_initializer())
